...
class Segment
{
    ...
    /**
     * Initializes the default client to use. Uses the socket consumer by
     * default.
     *
    ...
    {
        self::checkClient();
        $event = !empty($message["event"]) ? $message["event"] : false;
    ...
    public static function group(array $message)
    {
        ...
        self::assert($groupId && $userId,
            "Segment::group() expects userId and groupId");
    ...
    public static function alias(array $message)
    {
        ...
        self::assert($userId && $previousId,
            "Segment::alias() requires both userId and previousId");
    ...
    public static function validate($msg, $type)
    {
        ...
        self::assert($userId || $anonId,
            "Segment::$type() requires userId or anonymousId");
    }
